import pygame
from robot import all_robots, Robot, RobotState, BROADCAST_RANGE, BROADCAST_LIFETIME, Broadcast, SWARM_SIZE, OPERATOR_X, OPERATOR_Y, GPSBroadcast, GreedyBroadcast
import random
...
while running:
    ...
    #if tick % 240 == 0:
    #    # Instead of greedy broadcast, use CDS broadcast
